error id: file://<WORKSPACE>/chisel/b_npc_2/src/main/scala/IDU.scala:`<none>`.
file://<WORKSPACE>/chisel/b_npc_2/src/main/scala/IDU.scala
empty definition using pc, found symbol in pc: `<none>`.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/defaultw_mask.
	 -chisel3/defaultw_mask#
	 -chisel3/defaultw_mask().
	 -chisel3/util/defaultw_mask.
	 -chisel3/util/defaultw_mask#
	 -chisel3/util/defaultw_mask().
	 -ChiselHelpers.defaultw_mask.
	 -ChiselHelpers.defaultw_mask#
	 -ChiselHelpers.defaultw_mask().
	 -defaultw_mask.
	 -defaultw_mask#
	 -defaultw_mask().
	 -scala/Predef.defaultw_mask.
	 -scala/Predef.defaultw_mask#
	 -scala/Predef.defaultw_mask().
offset: 18404
uri: file://<WORKSPACE>/chisel/b_npc_2/src/main/scala/IDU.scala
text:
```scala
import chisel3._
