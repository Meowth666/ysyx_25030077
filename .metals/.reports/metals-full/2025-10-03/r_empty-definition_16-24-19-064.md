error id: file://<WORKSPACE>/chisel/b_npc_2/src/main/scala/ysyx_25030077.scala:`<none>`.
file://<WORKSPACE>/chisel/b_npc_2/src/main/scala/ysyx_25030077.scala
...
non-local guesses:
	 ...
	 -scala/Predef.Module().
offset: 333
uri: file://<WORKSPACE>/chisel/b_npc_2/src/main/scala/ysyx_25030077.scala
text:
```scala
import chisel3._
...
class top extends Module {
  ...
  val ysyx_25030077_ifu  = Module(new IFU())
  ...
  val l_uart = Module(new UART())
  val m_clint = Module(new clint())

  ysyx_25030077_ifu.io.ar.ready := c_arbiter.io.ifu_ready

  c_arbiter.io.ifu_valid := ysyx_25030077_ifu.io.ar.valid
  c_arbiter.io.pc := ysyx_25030077_ifu.io.ar.bits.addr
  ...
  f_gpr.io.ifu_Req <> ysyx_25030077_ifu.io.rd_Req
  ...
  j_pc_next.io.pc_count := ysyx_25030077_ifu.io.rd_Req.bits.addr
  ...
  h_data_control.io.pc_count := ysyx_25030077_ifu.io.rd_Req.bits.addr
