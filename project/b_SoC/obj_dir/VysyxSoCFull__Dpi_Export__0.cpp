...
int VysyxSoCFull::reg_read_rs1() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VysyxSoCFull___024root::reg_read_rs1\n"); );
    // Init
    ...
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VysyxSoCFull__Vcb_reg_read_rs1_t __Vcb = (VysyxSoCFull__Vcb_reg_read_rs1_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VysyxSoCFull__Syms*)(__Vscopep->symsp()), reg_read_rs1__Vfuncrtn__Vcvt);
    int reg_read_rs1__Vfuncrtn;
    reg_read_rs1__Vfuncrtn = reg_read_rs1__Vfuncrtn__Vcvt;
    return reg_read_rs1__Vfuncrtn;
}

int VysyxSoCFull::reg_read_rs2() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VysyxSoCFull___024root::reg_read_rs2\n"); );
    // Init
    ...
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VysyxSoCFull__Vcb_reg_read_rs2_t __Vcb = (VysyxSoCFull__Vcb_reg_read_rs2_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VysyxSoCFull__Syms*)(__Vscopep->symsp()), reg_read_rs2__Vfuncrtn__Vcvt);
    int reg_read_rs2__Vfuncrtn;
    reg_read_rs2__Vfuncrtn = reg_read_rs2__Vfuncrtn__Vcvt;
    return reg_read_rs2__Vfuncrtn;
}

int VysyxSoCFull::dnpc_read_data() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VysyxSoCFull___024root::dnpc_read_data\n"); );
    // Init
    ...
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    VysyxSoCFull__Vcb_dnpc_read_data_t __Vcb = (VysyxSoCFull__Vcb_dnpc_read_data_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    (*__Vcb)((VysyxSoCFull__Syms*)(__Vscopep->symsp()), dnpc_read_data__Vfuncrtn__Vcvt);
